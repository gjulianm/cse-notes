...
\begin{theorem}[Theorem\IS of existence and unicity for the mixed PDE problem] \label{thm:WellPosednessMixedProb} Let $V,Q$ be two Hilbert spaces and $V_0 = \set{v ∈ V \tq b(v,q) = 0 \; ∀q ∈ Q}$. Assume that:
\begin{itemize}
...
\begin{defn}[Bubble space][Space!bubble] ??
\end{defn}
