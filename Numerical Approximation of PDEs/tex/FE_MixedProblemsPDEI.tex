...
\begin{theorem}[Theorem\IS of existence and uniqueness for the mixed PDE problem][Existence and unicity\IS for mixed PDEs] \label{thm:PDE:WellPosednessMixedProb} Let $V,Q$ be two Hilbert spaces and $V_0 = \set{v ∈ V \tq b(v,q) = 0 \; ∀q ∈ Q}$. Assume that:
\begin{itemize}
